(function($) {
    ...
    */
	...
	function edgtfInitSingleProductLightbox() {
		var item = $('.edgtf-woo-single-page .product .images .woocommerce-product-gallery__image');
    ...
    function edgtfInitSingleProductImageSwitchLogic() {
        ...
        if(edgtf.body.hasClass('edgtf-woo-single-switch-image')){
	        ...
	        if(featuredImage.length) {
                featuredImage.on('click', function(e) {
	                e.preventDefault();
    ...
    */
    function edgtfInitSingleProductZoomImage() {
	    ...
	    var item = $('.no-touch .edgtf-woo-single-page-layout-standard.edgtf-zoom-image-enabled .images.woocommerce-product-gallery--with-images .woocommerce-product-gallery__image:first-child > a');
