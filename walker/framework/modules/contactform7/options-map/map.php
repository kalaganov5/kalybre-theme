...
if ( ! function_exists('walker_edge_contact_form_7_options_map') ) {

	function walker_edge_contact_form_7_options_map() {

		walker_edge_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title' => esc_html__( 'Contact Form 7', 'walker' ),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = walker_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title' => esc_html__( 'Custom Style 1', 'walker' )
		));

		//Text Typography

		$typography_text_group = walker_edge_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title' => esc_html__( 'Form Text Typography', 'walker' ),
			'description' => esc_html__( 'Setup typography for form elements text', 'walker' ),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = walker_edge_add_admin_row(array(
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Text Color', 'walker' ),
		));
		...
		$typography_text_row2 = walker_edge_add_admin_row(array(
		...
		$typography_text_row3 = walker_edge_add_admin_row(array(
		...
		$typography_label_group = walker_edge_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title' => esc_html__( 'Form Label Typography', 'walker' ),
			'description' => esc_html__( 'Setup typography for form elements label', 'walker' ),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = walker_edge_add_admin_row(array(
		...
		$typography_label_row2 = walker_edge_add_admin_row(array(
		...
		$background_border_group = walker_edge_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title' => esc_html__( 'Form Elements Background and Border', 'walker' ),
			'description' => esc_html__( 'Setup form elements background and border style', 'walker' ),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = walker_edge_add_admin_row(array(
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Background Color', 'walker' )
		));
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Background Transparency', 'walker' )
		));

		$background_border_row2 = walker_edge_add_admin_row(array(
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Transparency', 'walker' ),
		));
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Border Color', 'walker' )
		));
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Border Transparency', 'walker' )
		));

		$background_border_row3 = walker_edge_add_admin_row(array(
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Width', 'walker' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Radius', 'walker' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = walker_edge_add_admin_group(array(
			'name'			=> 'padding_group',
			'title' => esc_html__( 'Elements Padding', 'walker' ),
			'description' => esc_html__( 'Setup form elements padding', 'walker' ),
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = walker_edge_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		$margin_group = walker_edge_add_admin_group(array(
			'name'			=> 'margin_group',
			'title' => esc_html__( 'Elements Margin', 'walker' ),
			'description' => esc_html__( 'Setup form elements margin', 'walker' ),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = walker_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Textarea Height', 'walker' ),
			'description' => esc_html__( 'Enter height for textarea form element', 'walker' ),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = walker_edge_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title' => esc_html__( 'Button Typography', 'walker' ),
			'description' => esc_html__( 'Setup button text typography', 'walker' ),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = walker_edge_add_admin_row(array(
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Text Hover Color', 'walker' )
		));
		...
		$button_typography_row2 = walker_edge_add_admin_row(array(
		...
		$button_background_border_group = walker_edge_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title' => esc_html__( 'Button Background and Border', 'walker' ),
			'description' => esc_html__( 'Setup button background and border style', 'walker' ),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = walker_edge_add_admin_row(array(
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Background Hover Transparency', 'walker' )
		));

		$button_background_border_row2 = walker_edge_add_admin_row(array(
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Hover Color', 'walker' )
		));
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Hover Transparency', 'walker' )
		));

		$button_background_border_row3 = walker_edge_add_admin_row(array(
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Button Height', 'walker' ),
			'description' => esc_html__( 'Insert form button height', 'walker' ),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		walker_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Button Left/Right Padding', 'walker' ),
			'description' => esc_html__( 'Enter value for button left and right padding', 'walker' ),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = walker_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title' => esc_html__( 'Custom Style 2', 'walker' )
		));
        ...
        $panel_contact_form_style_3 = walker_edge_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title' => esc_html__( 'Custom Style 3', 'walker' )
        ));
        ...
        $typography_label_row3 = walker_edge_add_admin_row(array(
        ...
        $button_typography_row3 = walker_edge_add_admin_row(array(
	...
	add_action( 'walker_edge_options_map', 'walker_edge_contact_form_7_options_map', 20);
}