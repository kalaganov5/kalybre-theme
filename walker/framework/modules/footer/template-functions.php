...
if (!function_exists('walker_edge_register_footer_sidebar')) {
	...
	function walker_edge_register_footer_sidebar() {
		...
		register_sidebar(array(
			'id' => 'footer_column_1',
			'name'          => esc_html__( 'Footer Top Column 1', 'walker' ),
			'description'   => esc_html__( 'Widgets added here will appear in the first column of top footer area', 'walker' ),
		...
		register_sidebar(array(
			'id' => 'footer_column_2',
			'name'          => esc_html__( 'Footer Top Column 2', 'walker' ),
			'description'   => esc_html__( 'Widgets added here will appear in the second column of top footer area', 'walker' ),
		...
		register_sidebar(array(
			'id' => 'footer_column_3',
			'name'          => esc_html__( 'Footer Top Column 3', 'walker' ),
			'description'   => esc_html__( 'Widgets added here will appear in the third column of top footer area', 'walker' ),
		...
		register_sidebar(array(
			'id' => 'footer_column_4',
			'name'          => esc_html__( 'Footer Top Column 4', 'walker' ),
			'description'   => esc_html__( 'Widgets added here will appear in the fourth column of top footer area', 'walker' ),
		...
		register_sidebar(array(
			'name' => esc_html__( 'Footer Bottom', 'walker' ),
			'id' => 'footer_text',
			'description'   => esc_html__( 'Widgets added here will appear in the footer bottom text area', 'walker' ),
		...
		register_sidebar(array(
			'name' => esc_html__( 'Footer Bottom Left', 'walker' ),
			'id' => 'footer_bottom_left',
			'description'   => esc_html__( 'Widgets added here will appear in the left side of footer bottom area', 'walker' ),
		...
		register_sidebar(array(
			'name' => esc_html__( 'Footer Bottom Right', 'walker' ),
			'id' => 'footer_bottom_right',
			'description'   => esc_html__( 'Widgets added here will appear in the right side of footer bottom area', 'walker' ),
			'before_widget' => '<div id="%1$s" class="widget edgtf-footer-bottom-left %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h4 class="edgtf-footer-widget-title">',
			'after_title' => '</h4>'
