...
if ( !function_exists('walker_edge_register_full_screen_menu_sidebars') ) {
	...
	function walker_edge_register_full_screen_menu_sidebars() {
		...
		register_sidebar(array(
			'name' => esc_html__( 'Fullscreen Menu Top', 'walker' ),
			'id' => 'fullscreen_menu_above',
			'description' => esc_html__( 'This widget area is rendered above fullscreen menu', 'walker' ),
		...
		register_sidebar(array(
			'name' => esc_html__( 'Fullscreen Menu Bottom', 'walker' ),
			'id' => 'fullscreen_menu_below',
			'description' => esc_html__( 'This widget area is rendered below fullscreen menu', 'walker' ),
