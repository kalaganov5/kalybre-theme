...
/*************** PRODUCT LISTS FILTERS - begin ***************/
    ...
    add_action( 'woocommerce_before_shop_loop', 'title_archive', 5 );
    function title_archive() {
        echo '<h1 class="product_title entry-title">' . woocommerce_page_title(false) . '</h1>';
    }
    ...
    add_action('woocommerce_after_shop_loop', 'desc_archive', 200);
    function desc_archive() {
        the_archive_description('<div class="desc_archive">', '</div>');
    }
	...
	/*************** Product Info Position Is On Image Hover ***************/
		...
		add_action('walker_edge_woo_pl_info_on_image_hover', 'woocommerce_template_loop_price', 15);
	...
	/*************** Product Info Position Is Below Image ***************/
		...
		add_action('walker_edge_woo_pl_info_below_image', 'woocommerce_template_loop_price', 14);
		...
		//Change add to cart position
		remove_action('woocommerce_after_shop_loop_item', 'woocommerce_template_loop_add_to_cart', 10);
		add_action('walker_edge_woo_pl_info_below_image', 'woocommerce_template_loop_add_to_cart', 24);
