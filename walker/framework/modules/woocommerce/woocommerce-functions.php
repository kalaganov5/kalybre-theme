...
if(!function_exists('walker_edge_woocommerce_share')) {
    ...
    function walker_edge_woocommerce_share() {
        if (walker_edge_is_woocommerce_installed() && walker_edge_core_installed()) {
...
if(!function_exists('walker_edge_woocommerce_quick_view_button')) {
	function walker_edge_woocommerce_quick_view_button() {
		...
		if(walker_edge_is_yith_wcqv_install()) {
			...
			print '<div class="edgtf-yith-wcqv-holder"><a href="#" class="yith-wcqv-button" data-product_id="'.$product->get_id().'"><span class="edgtf-yith-wcqv-icon ion-ios-eye-outline"></span><span class="edgtf-yith-wcqv-label">'.$label.'</span></a></div>';
		}
	}
}